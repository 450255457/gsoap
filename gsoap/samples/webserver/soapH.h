...
#define soap_read_f__form2(soap, data) ( soap_begin_recv(soap) || !soap_get_f__form2(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
...
#define soap_read_f__formResponse(soap, data) ( soap_begin_recv(soap) || !soap_get_f__formResponse(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
...
#define soap_read_f__form1(soap, data) ( soap_begin_recv(soap) || !soap_get_f__form1(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
...
#define soap_read_PointerTof__formResponse(soap, data) ( soap_begin_recv(soap) || !soap_get_PointerTof__formResponse(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
