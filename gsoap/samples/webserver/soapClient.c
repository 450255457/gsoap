...
SOAP_SOURCE_STAMP("@(#) soapClient.c ver 2.8.23 2015-09-16 07:27:48 GMT")
...
{	struct f__form1 soap_tmp_f__form1;
	...
	soap_serializeheader(soap);
	soap_serialize_f__form1(soap, &soap_tmp_f__form1);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_f__form1(soap, &soap_tmp_f__form1, "f:form1", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{
	soap_default_f__form1(soap, _param_1);
	soap_begin(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_f__form1(soap, _param_1, "f:form1", NULL);
...
{	struct f__form2 soap_tmp_f__form2;
	...
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
	soap_serialize_f__form2(soap, &soap_tmp_f__form2);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_f__form2(soap, &soap_tmp_f__form2, "f:form2", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_f__formResponse(soap, _param_2, "f:formResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
