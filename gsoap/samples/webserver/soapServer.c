...
SOAP_SOURCE_STAMP("@(#) soapServer.c ver 2.8.23 2015-09-16 07:27:48 GMT")
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_request(struct soap *soap)
{
	...
	if (!soap_match_tag(soap, soap->tag, "f:form1"))
		return soap_serve_f__form1(soap);
	if (!soap_match_tag(soap, soap->tag, "f:form2"))
		return soap_serve_f__form2(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_f__form1(struct soap *soap)
{	struct f__form1 soap_tmp_f__form1;
	soap_default_f__form1(soap, &soap_tmp_f__form1);
	if (!soap_get_f__form1(soap, &soap_tmp_f__form1, "f:form1", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = f__form1(soap);
	if (soap->error)
		return soap->error;
	return soap_closesock(soap);
}

SOAP_FMAC5 int SOAP_FMAC6 soap_serve_f__form2(struct soap *soap)
{	struct f__form2 soap_tmp_f__form2;
	struct f__formResponse _param_2;
	soap_default_f__formResponse(soap, &_param_2);
	soap_default_f__form2(soap, &soap_tmp_f__form2);
	if (!soap_get_f__form2(soap, &soap_tmp_f__form2, "f:form2", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = f__form2(soap, &_param_2);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
	soap_serialize_f__formResponse(soap, &_param_2);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_f__formResponse(soap, &_param_2, "f:formResponse", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
